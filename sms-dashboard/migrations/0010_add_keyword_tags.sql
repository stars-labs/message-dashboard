...
-- Add permission for managing keyword tags
INSERT OR IGNORE INTO permissions (id, resource, action) VALUES
    ('keywords.read', 'keywords', 'read'),
    ('keywords.write', 'keywords', 'write'),
    ('keywords.delete', 'keywords', 'delete');

-- Grant keyword permissions to admin and user groups
