...
ssh root@10.171.150.2 "lsusb | awk '{print \$2}' | sort | uniq -c"
# Hub vs modem split on a given bus
ssh root@10.171.150.2 'echo "bus3 hubs: $(lsusb | grep "Bus 003" | grep -c 1a40)  modems: $(lsusb | grep -c 2c7c)"'
# Enumeration failures
ssh root@10.171.150.2 'dmesg | grep -iE "unable to enumerate|not accepting address" | tail'
```
